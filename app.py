...
model_params = {
    ...
    "num_package": Slider("Number of packages", 20, 1, 50, 1, dtype=int),
    ...
    "max_weight": Slider("Max Weight", 5, 2, 10, 1, dtype=int),
    "min_weight": Slider("Min Weight", 2, 2, 10, 1, dtype=int),
    "q_learning": q
